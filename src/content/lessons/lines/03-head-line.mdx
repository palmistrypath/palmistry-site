...
<Figure src="/images/lessons/lines/linesl304.webp" alt="Illustration: a single palm with three overlaid endpoint positions for the head line, all beginning at the same origin. The first runs horizontally and ends in the mid-outer palm, staying level. The second descends and ends deep in the mount of Luna at the base of the outer palm. The third splits at the end into two branches — one staying level, one descending toward Luna — showing a forked termination. Each endpoint is labeled: 'straight,' 'deep into Luna,' 'forked.' Finger bases and the mount of Luna are lightly labeled. Other lines faint." caption="Head line endpoints: straight, descended into Luna, and forked. The forked ending is traditionally read as combining both qualities." />
